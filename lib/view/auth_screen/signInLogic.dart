...
import 'package:taush/view/auth_screen/auth_screens.dart';
import 'package:taush/view/seller/seller_persistant_nav_bar/seller_bottom_nav_bar.dart';
import 'package:taush/view/user/user_data_screen/user_data_input_screen.dart';
import 'package:taush/view/user/user_persistant_nav_bar/user_bottom_nav_bar.dart';
...
class _SignInLogicState extends State<SignInLogic> {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: Image(
        image: AssetImage('assets/images/taush_splash_screen.png'),
        fit: BoxFit.fill,
      ),
    );
  }
