...
import 'package:taush/controller/services/auth_services/auth_services.dart';
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                          text: 'New to taush? ', style: textTheme.bodyMedium)
                    ],
                  ),
                ),
              ],
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'By Continuing you agree to taush\'s ',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                CommonFunctions.blankSpace(height * 0.02, 0),
                Text(
                  'By enrolling your mobile phone number, you concent to receive automated security notifications via text message from taush.\nMessage and data rates may apply.',
                  style: textTheme.bodyMedium,
                ),
                CommonFunctions.blankSpace(height * 0.02, 0),
                CommonAuthButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Text(
          '© 1996-2023, taush.com, Inc. or its affiliates',
