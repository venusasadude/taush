...
import 'package:taush/constants/common_functions.dart';
import 'package:taush/constants/constants.dart';
...
import 'package:taush/controller/services/product_services/product_services.dart';
import 'package:taush/controller/services/user_data_crud_services/user_data_CRUD_services.dart';
import 'package:taush/model/address_model.dart';
import 'package:taush/model/product_model.dart';
import 'package:taush/utils/colors.dart';
import 'package:taush/view/user/address_screen/address_screen.dart';
import 'package:taush/view/user/product_category_screen/product_category_screen.dart';
import 'package:taush/view/user/product_screen/product_screen.dart';
import 'package:taush/view/user/searched_product_screen/searched_product_screen.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:flutter/material.dart' hide CarouselController; // avoid clash
...
class _HomeScreenState extends State<HomeScreen> {
  cs.CarouselSliderController todaysDealsCarouselSliderController =
        ...
        child: Column(
          children: [
            ...
            TodaysDealHomeScreenWidget(
                todaysDealsCarouselSliderController:
                    todaysDealsCarouselSliderController),
            CommonFunctions.divider(),
...
class TodaysDealHomeScreenWidget extends StatelessWidget {
  const TodaysDealHomeScreenWidget({
    super.key,
    required this.todaysDealsCarouselSliderController,
  });

  final cs.CarouselSliderController todaysDealsCarouselSliderController;
          ...
          if (dealOfTheDayProvider.dealsFetched == false) {
            ...
            return Column(
              ...
              children: [
                ...
                CommonFunctions.blankSpace(height * 0.01, 0),
                CarouselSlider(
                  carouselController: todaysDealsCarouselSliderController,
